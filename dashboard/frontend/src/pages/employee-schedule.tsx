...
import { Calendar, CalendarDays, Clock, MapPin, User as UserIcon, Plus, Edit, Trash2, CheckCircle, XCircle, AlertCircle } from "lucide-react";
...
export default function EmployeeSchedule() {
  ...
  const syncCalendarMutation = useMutation({
    mutationFn: async () => {
      return await apiRequest('/api/sync/google-calendar', 'POST');
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/schedules"] });
      toast({
